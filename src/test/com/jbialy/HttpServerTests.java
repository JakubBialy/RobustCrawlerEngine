...
import com.jbialy.mock.MockCounterReceiver;
...
import com.jbialy.server.MockDownloaderModule;
...
import static com.jbialy.rce.sneakytry.TryUtils.sneakyTry;
...
public class HttpServerTests {
    ...
    public void mockServerEngineTest() throws InterruptedException {
        ...
        JobDataV3<String, URI> job = new JobBuilderV3<String, URI>
                (() -> CollectionWorkspace.fromFileOrElseCreateFromSeed(URI.class, checkpointFile, seed))
                .setConfig(new EngineConfigV3(4, 2, Long.MAX_VALUE)) //Optional
        ...
        DownloadEngineV3 engineV3 = new DownloadEngineV3(job);
        engineV3.start();
