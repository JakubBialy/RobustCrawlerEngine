...
public class Workspace2ImplBenchmark {
    @Param({"100000"})
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(Workspace2ImplBenchmark.class.getSimpleName())
                .forks(1)
...
//                .measurementIterations(10)
    ...
    @NotNull
    private static GeneralPurposeWorkspace<URI> createWorkspace() {
        ...
        return GeneralPurposeWorkspace.createCustom(allItems, todo, inProgress, done, damaged);
    }

    @Benchmark
    public void Workspace2Impl_add_crawlerEngineExtractedUris(Blackhole blackhole, Mock mockData) {
        GeneralPurposeWorkspace<URI> workspace = createWorkspace();
    ...
    @Benchmark
    public void Workspace2Impl_simulate_crawlerEngine(Blackhole blackhole, Mock mockData) {
        GeneralPurposeWorkspace<URI> workspace = createWorkspace();
