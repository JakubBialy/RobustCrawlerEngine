...
public class GenericRequestHelper {
    ...
    public static HttpRequest generateRequest(URI uri) {
        return HttpRequest.newBuilder()
                .uri(uri)
                .header("User-Agent", "RobustCrawlerEngine (+https://github.com/JakubBialy/RobustCrawlerEngine)")
                .GET()
                .build();
    }

    public static HttpRequest generateRequest(URI uri, String userAgentString) {
        return HttpRequest.newBuilder()
                .uri(uri)
