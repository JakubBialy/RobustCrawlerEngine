...
//    private long tasksInProgress = 0L;
    ...
    public JobStatistics(JobStatistics other) {
        this.tasksSentToReceiver = other.tasksSentToReceiver;
        this.doneTasks = other.doneTasks;
//        this.tasksInProgress = other.tasksInProgress;
        this.tasksTodo = other.tasksTodo;
    }
...
//        return new JobStatistics(tasksSentToReceiver, doneTasks, tasksInProgress, tasksTodo);
        return new JobStatistics(tasksSentToReceiver, doneTasks, tasksTodo);
    }
...
//        this.doneTasks++;
//    }
    public synchronized void moveOneTaskFromToDoToDone() {
        this.tasksTodo--;
        this.doneTasks++;
    }
...
//        return this.doneTasks + this.tasksInProgress + this.tasksTodo;
        return this.doneTasks + this.tasksTodo;
    }
}
